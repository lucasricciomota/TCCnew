...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-4 texto">
            <p>A teoria de que São Francisco do Sul foi descoberta pelos franceses nunca foi provada.
                ...
                Parte desta hipótese se deve a uma interpretação das discussões teóricas do historiador Costa Pereira em seu livro "História de São Francisco do Sul", que afirmou veementemente no mesmo livro, que "jamais se saberia com certeza aonde Gonneville aportou".
